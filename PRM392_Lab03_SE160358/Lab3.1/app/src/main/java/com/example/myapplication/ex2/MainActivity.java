...
// Image Dropdown list (Spinner)
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name.isEmpty() || description.isEmpty() || selectedImage == -1) {
                    ...
                    if (selectedImage == -1) {
                        Toast.makeText(com.example.myapplication.ex2.MainActivity.this, "Vui lòng chọn một hình ảnh!", Toast.LENGTH_SHORT).show();
                    }
                    return;
                }
                ...
                Toast.makeText(com.example.myapplication.ex2.MainActivity.this, "Thêm mới trái cây thành công", Toast.LENGTH_SHORT).show();
        ...
        btnEdit.setOnClickListener(view -> {
            if (selectedPos == -1) {
                Toast.makeText(com.example.myapplication.ex2.MainActivity.this, "Hãy chọn trái cây cần sửa!", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            adapter.notifyDataSetChanged(); // Cập nhật danh sách
            Toast.makeText(com.example.myapplication.ex2.MainActivity.this, "Cập nhật trái cây thành công!", Toast.LENGTH_SHORT).show();
        ...
        btnRemove.setOnClickListener(view -> {
            if (selectedPos != -1) {
                ...
                new androidx.appcompat.app.AlertDialog.Builder(com.example.myapplication.ex2.MainActivity.this)
                        .setTitle("Xác nhận")
                        ...
                        .setPositiveButton("Xóa", (dialog, which) -> {
                            ...
                            Toast.makeText(com.example.myapplication.ex2.MainActivity.this, "Xóa trái cây thành công!", Toast.LENGTH_SHORT).show();
                        })
                        .setNegativeButton("Hủy", (dialog, which) -> {
                            // Hủy xóa
                            Toast.makeText(com.example.myapplication.ex2.MainActivity.this, "Đã hủy xóa!", Toast.LENGTH_SHORT).show();
                        })
                        .show();
            } else {
                Toast.makeText(com.example.myapplication.ex2.MainActivity.this, "Hãy chọn trái cây cần xóa!", Toast.LENGTH_SHORT).show();
            }
        });
